...
#r {1 : 7, 2 : 7, 3 : 1, 4 : 5, 5 : 9, 6 : 8, 7 : 7, 8 : 5, 9 : 8, 10 : 6}
...
# It reaches 7 on a loop of length 1
print()
follow_the_arrows_from(mapping, 3)
# It starts with a stalk of length 2
# It reaches 7 on a loop of length 1
print()
follow_the_arrows_from(mapping, 4)
#It starts with a stalk of length 1
# It reaches 5 on a loop of length 3
print()
follow_the_arrows_from(mapping, 5)
# It is on a loop of length 3
print()
follow_the_arrows_from(mapping, 7)
# It is on a loop of length 1
print()
follow_the_arrows_from(mapping, 10)
# It starts with a stalk of length 2
# It reaches 8 on a loop of length 3
print()
longest_strictly_decreasing_sequences_to(mapping, 1)
# 3 -> 1
print()
longest_strictly_decreasing_sequences_to(mapping, 2)
print()
